    ...
    return (
        <div className='flex justify-center gap-5 p-5'>
            <div className="relative hover:shadow-lg transition transform hover:scale-102 rounded-xl">
                <img src={Banners[0]} className="h-[500px] rounded-xl" />

                
                <h2 className="absolute top-0 left-0 text-white text-3xl font-bold">
                    Stay refreshed with every sip of pure coolness
                </h2>
            </div>
            <div className="relative hover:shadow-lg transition transform hover:scale-102 rounded-xl">
                <img src={Banners[1]} className="h-[500px] rounded-xl" />

                {/* Text on Image */}
                <h2 className="absolute bottom-0 left-0 text-white text-3xl font-bold">
                    Beat the summer heat with chilled refreshing drinks
                </h2>
            </div>
            <div className="relative hover:shadow-lg transition transform hover:scale-102 rounded-xl">
                <img src={Banners[2]} className="h-[500px] rounded-xl" />
