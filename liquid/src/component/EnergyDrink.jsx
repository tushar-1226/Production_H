...
const Banner = () => {
  ...
  return (
    <div className='flex flex-col'>
      ...
      <div className=" relative flex  w-full rounded-xl px-5 gap-8 border border-gray-900 mx-2 py-2 overflow-x-auto scrollbar-hide">

        <ChevronLeft size={40} className=' fixed top-70 left-4 z-1 bg-gray-300 rounded-full p-1'/>
        ...
        <ChevronRight size={40} className='fixed top-70 z-1 right-4 bg-gray-300 rounded-full p-1'/>
      </div>
    </div>
  )
}
