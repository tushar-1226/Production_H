...
const Container = () => {
  ...
  return (
    <div className='flex w-full container pb-6 mb-20' >
      <div className='w-1/3'>
        <div className=''>
          ...
          <div className=''>
            <h1 className="text-5xl font-semibold leading-tight pl-15 xyz">
              Refined Sips <br />
              for Refined Tastes
            </h1>      
          </div>
      ...
      <div className='w-1/3'>
        <div className='flex justify-center'>
          <div className='h-[450px] w-[350px] mt-10 category border-2 border-gray-200 rounded-2xl why_liquid'>
            <div className='m-5'>
